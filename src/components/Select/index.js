...
const Select = ({
  ...
  const changeValue = (newValue) => {
    // ajout de la variable newValue dans onChange
    onChange(newValue);
    setValue(newValue);
    setCollapsed(newValue);
  };

  // ajout de nouvelles constantes pour la gestion du clic et du keypress
...
{/* modification des listes avec rajout de l'indexation et du comportement pour le clic et le keypress */}
